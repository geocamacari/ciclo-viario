...
map.getView().fit([-4266364.700845, -1426692.171568, -4264739.025460, -1425769.486021], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Webmap Sistema Viário e Cicloviário</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (144 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapeamento online de elementos do sistema viário e cicloviário em geral como suporte para elaboração de estudos, projetos e planejamento urbano.';
            }
